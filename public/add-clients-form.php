...
if (isset($_POST['btnAdd'])) {
    ...
    if ($_FILES['profile']['size'] != 0 && $_FILES['profile']['error'] == 0 && !empty($_FILES['profile'])) {
        ...
        $sql = "INSERT INTO clients (profile,name) VALUES ('$upload_image','$name')";
        $db->sql($sql);
    }
    $result = $db->getResult();
    if (!empty($result)) {
    ...
    if ($result == 1) {
        $error['add_ads'] = "<section class='content-header'>
                                            <span class='label label-success'>Clients Added Successfully</span> </section>";
    } else {
...
<section class="content-header">
    <h1>Add Clients <small><a href='clients.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to Clients</a></small></h1>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="col-md-8">
                                        ...
                                        <input type="file" name="profile" onchange="readURL(this);" accept="image/png,  image/jpeg" id="profile" required/><br>
                                        <img id="blah" src="#" alt="" />
                                    </div>
                                </div>
                            </div> 

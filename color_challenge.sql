...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2023 at 06:55 AM
...
INSERT INTO `users` (`id`, `email`, `name`, `upi`, `earn`, `coins`, `balance`, `referred_by`, `refer_code`, `withdrawal_status`, `challenge_status`, `status`, `joined_date`, `fcm_id`, `datetime`, `last_updated`) VALUES
